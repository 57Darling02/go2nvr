...
import (
	...
	"github.com/57Darling02/go2nvr/internal/ffmpeg/device"
	"github.com/57Darling02/go2nvr/internal/ffmpeg/hardware"
	"github.com/57Darling02/go2nvr/internal/ffmpeg/virtual"
...
var defaults = map[string]string{
	...
	// hardware Rockchip
	// important to use custom ffmpeg https://github.com/57Darling02/go2nvr/issues/768
...
func parseArgs(s string) *ffmpeg.Args {
	...
	if query != nil {
		...
		for _, raw := range query["raw"] {
			// support templates https://github.com/57Darling02/go2nvr/issues/487
